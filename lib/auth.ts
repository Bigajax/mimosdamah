...
export const COOKIE_SESSAO = "mimos_painel";

const SENHA_LOCAL = process.env.PAINEL_SENHA_LOCAL ?? "mimos";
const SEGREDO = process.env.PAINEL_SEGREDO ?? "mimos-desenvolvimento";
